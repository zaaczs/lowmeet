    ...
    <footer className="border-t bg-white">
      <div className="mx-auto flex w-full max-w-none flex-col gap-4 px-3 py-6 text-sm text-muted-foreground sm:px-4 md:flex-row md:items-start md:justify-between md:gap-6 md:px-4 lg:px-5 xl:px-6">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex shrink-0 items-center gap-3 self-center rounded-xl border bg-white px-4 py-3 text-sm font-medium text-slate-700 transition hover:bg-muted md:self-start"
